...
with st.container():
    ...
    # # User input: Image or canvas drawing
    # file_image = st.file_uploader("Upload Image", type=["jpg", "png", "jpeg"])

    # Predict button
    if st.button('Predict'):
        # model_new = digitrecognizer(model_choice,epochs,learning_rate,X,y,X_train, X_test, y_train, y_test)
...
#     st.warning("Please upload a new image or draw on the canvas for another prediction.")
